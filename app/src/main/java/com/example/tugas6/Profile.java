...
import com.example.tugas6.databinding.ProfileBinding;
...
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Profile.this, DisplayData.class));
            }
        });
...
//edit hide and submit visible
                    ...
                    Intent a = new Intent(Profile.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
